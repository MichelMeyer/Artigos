...
ggplot(benchMark) + geom_col(aes(x = rep, y = mean, fill = operator), position = "dodge") + labs(title = "Tempo transcorrido para cada operador", x = "Observações do operador", y = "Media em microsegundos")
